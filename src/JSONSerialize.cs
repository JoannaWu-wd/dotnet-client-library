...
/// <remarks></remarks>
    sealed class JSONSerialize
    {
        ...
        public static RData parseRObject(JToken jobject)
        {
            ...
            if (data == null)
            {
                // Continue parsing if the value is not empty.
        ...
        //function to convert RData to JSON markup
        //this is a recursive function that will create JSON markup for R lists and R dataframes
        //and will call itself to create the JSON markup for the objects contained within them
        //this function will also create the JSON markup for R vectors and R matrices
        //and will call itself to create the JSON markup for the objects contained within them
        //this function will also create the JSON markup for R primitives and R dates
        //and will call itself to create the JSON markup for the objects contained within them
        //this function will also create the JSON markup for R factors and R dates
        //and will call itself to create the JSON markup for the objects contained within them
        //this function will also create the JSON markup for R dataframes and R lists
        public static String createJSONfromRData(RData data)
        {
        ...
        //function to check if the RData object is empty and return null if it is
        //this function will also check if the RData object is null and return null if it is
        //this function will also check if the RData object is empty and return null if it is
        //this function will also check if the RData object is null and return null if it is
        //this function will also check if the RData object is empty and return null if it is
        public static RData checkEmptyValue(RData data)
        {
            if (data == null)
            {
                return null;
        ...
        //function to update the JSON markup with the new value
        //this is a recursive function that will update the JSON markup for R lists and R dataframes
        //and will call itself to update the JSON markup for the objects contained within them
        //this function will also update the JSON markup for R vectors and R matrices
        //and will call itself to update the JSON markup for the objects contained within them
        public static String updateJSONfromRData(RData data, String json)
        {
            JObject parent = new JObject();
            JToken token = parent.Value<JToken>();
            return updateJSONfromRData(data, ref token, json);
        }


        //function to delete the JSON markup for the RData object
        //this is a recursive function that will delete the JSON markup for R lists and R dataframes
        //and will call itself to delete the JSON markup for the objects contained within them
        //this function will also delete the JSON markup for R vectors and R matrices
        //and will call itself to delete the JSON markup for the objects contained within them
        public static String deleteJSONfromRData(RData data, String json)
        {
            JObject parent = new JObject();
            JToken token = parent.Value<JToken>();
            return deleteJSONfromRData(data, ref token, json);
        }

        //function to edit the JSON markup for the RData object
        //this is a recursive function that will edit the JSON markup for R lists and R dataframes
        //and will call itself to edit the JSON markup for the objects contained within them
        //this function will also edit the JSON markup for R vectors and R matrices
        public static String editJSONfromRData(RData data, String json)
        {
            JObject parent = new JObject();
            JToken token = parent.Value<JToken>();
            return editJSONfromRData(data, ref token, json);
        }
